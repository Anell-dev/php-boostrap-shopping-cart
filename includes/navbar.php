...
<nav class="container__principal-nav">
    ...
    <ul class="container__nav-list">
        ...
        <li class="container__nav-items">
            <a href="/php-boostrap-shopping-cart/views/product.php" 
            data-section="carrusel-product" 
        ...
        <li class="container__nav-items">
            ...
            <a href="/php-boostrap-shopping-cart/views/storecar.php" 
            data-section="store-card">STORECART</a>
        </li>
    </ul> 
  ...
  <div class="cart-container">
        <button class="cart-button">
            ...
            <!-- Aqui puedes declarar la variable y cuenta la cantidad de productos en el carrito 
            y los agregas aqui------[0] 
            -->
